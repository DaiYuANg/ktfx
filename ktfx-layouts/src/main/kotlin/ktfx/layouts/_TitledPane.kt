 ...
 */
public fun NodeContainer.titledPane(title: String? = null): TitledPane =
 ...
 * @return the control added.
 */
public fun TitledPaneContainer.titledPane(title: String? = null): TitledPane =
    titledPane(title = title) {}
 ...
 * @return the control added.
 */
public inline fun NodeContainer.titledPane(
    title: String? = null,
    configuration: (@KtfxLayoutDslMarker KtfxTitledPane).() -> Unit
): TitledPane {
  contract { callsInPlace(configuration, EXACTLY_ONCE) }
 ...
 * @return the control added.
 */
public inline fun TitledPaneContainer.titledPane(
    title: String? = null,
    configuration: (@KtfxLayoutDslMarker KtfxTitledPane).() -> Unit
): TitledPane {
  contract { callsInPlace(configuration, EXACTLY_ONCE) }
