...
class NotificationsBuilder internal constructor() {
  ...
  /**
   * The dialog window owner - which can be [javafx.stage.Screen], [javafx.stage.Window], or
   * [javafx.scene.Node].
   */
  var owner: Any
    @Deprecated(NO_GETTER, level = ERROR) get() = noGetter()
   ...
   * notifications exceed the threshold limit. A value of zero will disable the threshold behavior.
   */
