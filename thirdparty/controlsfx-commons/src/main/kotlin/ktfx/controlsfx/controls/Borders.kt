...
class BordersBuilder internal constructor(node: Node) {
  ...
  class EmptyBuilder internal constructor(private val nativeBorders: Borders.EmptyBorders) {
    ...
    /**
     * Specifies that the wrapped Node should be wrapped with the given padding for each of its four
     * sides
     */
  ...
  class LineBuilder internal constructor(private val nativeBorders: Borders.LineBorders) :
    ...
    /**
     * Specifies that the wrapped Node should be wrapped with the given colours for each of its four
     * sides.
     */
    ...
    /**
     * Specifies that the wrapped Node should be wrapped with the given line thickness for each of
     * its four sides.
     */
