...
val Dialog<*>.buttons: DialogButtonContainer
  get() = DialogButtonContainer(this)
...
open class DialogButtonContainer internal constructor(private val nativeDialog: Dialog<*>) {
  ...
  inline fun previous(configuration: Button.() -> Unit): Button = add(PREVIOUS).apply(configuration)
