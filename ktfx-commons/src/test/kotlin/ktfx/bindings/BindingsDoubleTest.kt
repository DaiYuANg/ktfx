...
class BindingsDoubleTest {
  ...
  fun multipleDependencies() {
    ...
    val binding1 =
        doubleBindingOf(dependency1, dependency2) { dependency1.value + dependency2.value }
    ...
    val binding2 =
        doubleBindingOf(listOf(dependency3, dependency4)) { dependency3.value + dependency4.value }
