...
class BindingsFloatTest {
  ...
  fun multipleDependencies() {
    ...
    val binding1 =
        floatBindingOf(dependency1, dependency2) { dependency1.value + dependency2.value }
    ...
    val binding2 =
        floatBindingOf(listOf(dependency3, dependency4)) { dependency3.value + dependency4.value }
