...
abstract class BaseTreeTableColumnTest {
  ...
  abstract fun <S, T> TreeTableColumn<S, T>.callOnEditStart(
      action: (TreeTableColumn.CellEditEvent<S, T>) -> Unit
  )

  abstract fun <S, T> TreeTableColumn<S, T>.callOnEditCommit(
      action: (TreeTableColumn.CellEditEvent<S, T>) -> Unit
  )

  abstract fun <S, T> TreeTableColumn<S, T>.callOnEditCancel(
      action: (TreeTableColumn.CellEditEvent<S, T>) -> Unit
  )
