...
abstract class BaseTreeViewTest {
  ...
  fun onEditStart() {
    ...
    tree.onEditStart.handle(
        TreeView.EditEvent(tree, TreeView.editStartEvent<String>(), tree.root, "", ""))
  }
  ...
  fun onEditCommit() {
    ...
    tree.onEditCommit.handle(
        TreeView.EditEvent(tree, TreeView.editCommitEvent<String>(), tree.root, "", ""))
  }
  ...
  fun onEditCancel() {
    ...
    tree.onEditCancel.handle(
        TreeView.EditEvent(tree, TreeView.editCancelEvent<String>(), tree.root, "", ""))
  }
